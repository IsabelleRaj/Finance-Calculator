...
carry_on = True
while carry_on:
    # Request user input to choose the type of calculator
    print("""\n===================================================================================
          \nMenu:
    ...
    # Proceed according to the user's chosen type of calculator
    if choice == 'investment':
        ...
        while True:
            try:
                ...
                print("Error: You have tried to enter a non-numerical character.")
